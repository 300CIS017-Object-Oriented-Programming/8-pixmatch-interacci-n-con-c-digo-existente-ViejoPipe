...
# La funcion ReadPictureFile toma un parametro wch_fl, mediante este parametro devuelve su contenido como una cadena
...
""" 
El procedimiento PreNewGame se encarga de preparar el juego para una nueva partida, 
inicializando las variables de estado y creando los botones del tablero con emojis asignados segun la dificultad
"""
def PreNewGame():
    total_cells_per_row_or_col = mystate.GameDetails[2]
...
# El procedimiento NewGame configura y maneja el estado de un nuevo juego en la aplicacion
def NewGame():
    ResetBoard()
    total_cells_per_row_or_col = mystate.GameDetails[2]
